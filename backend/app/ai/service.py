...
class AIService:
    ...
    def _execute_generation(
        ...
        *,
        operation: str,
        request: RequestT,
        generate: Callable[[RequestT], AIExecutionResult[str]],
        ...
        try:
            ...
            if context is not None and self.observability_service is not None:
                self.observability_service.execution_failed(context, exc)
            raise
        ...
        if context is not None and self.observability_service is not None:
            ...
            self.observability_service.execution_succeeded(context)
    ...
    def generate_ats_optimization(
        ...
        *,
        ...
        result = self.execute_ats_optimization(
            request,
            request_id=request_id,
            user_id=user_id,
            resume_id=resume_id,
        ...
        if missing_keywords:
            recommendations.append(
                "Consider incorporating the missing ATS keywords "
